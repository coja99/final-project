	...
	<div class="row">
		...
		<div class="col-xl-8 col-lg-8 offset-xl-2 offset-lg-2">
			...
			<section id="contact" class="margin-bottom-60">
				...
				<form method="post" name="contactform" id="contactform" autocomplete="on" action="oglas.php">
					<div class="row">
						<div class="col-md-6">
							<div class="input-with-icon-left">
								<input class="with-border" name="name" type="text" id="name" placeholder="Ime oglasa" required="required" />
					...
					<div>
						<textarea class="with-border" name="comments" cols="40" rows="5" id="comments" placeholder="Deksripcija oglasa" spellcheck="true" required="required"></textarea>
					</div>
